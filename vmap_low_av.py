...
np.save("low_av_mcmc_120723.npy", mcmc_samples)
...
np.save("low_av_laplace_120723.npy", laplace_samples)
...
np.save("low_av_zltn_120723.npy", zltn_samples)
...
np.save("low_av_multinormal_120723.npy", multinormal_samples)
