...
for i in range(100):
	...
	model.fit_with_vi_laplace_multivariatenormal(str(dataset) + "/" + str(i)  + '_multivariatenormal_redo', epsilons_on=epsilons_on, init_strategy='median')
