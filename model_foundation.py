...
class Model(object):
    ...
    def fit(self, num_samples, num_warmup, num_chains, output, result_path, chain_method='parallel', init_strategy='median'):
        ...
        nuts_kernel = NUTS(self.fit_model, adapt_step_size=True, init_strategy=init_strategy, max_tree_depth=9)
...
if __name__ == '__main__':
    ...
    model.fit(250, 250, 4, 'foundation_fit_9tree', 'T21', chain_method='vectorized')
